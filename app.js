...
// define our AJAX fetch request
  try{
    const res = await fetch(req).then(res => checkStatus(res))
    const data = await res.json(res)
    document.getElementById('iptext').innerHTML = data.client_ip
  } catch(e) {
    console.log('Oops, there was a network error:', e.message)
  } 
